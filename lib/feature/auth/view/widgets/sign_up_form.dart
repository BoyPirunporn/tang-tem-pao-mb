...
import 'package:tang_tem_pao_mb/core/utils.dart';
...
import 'package:tang_tem_pao_mb/feature/auth/viewmodel/auth_signup_viewmodel.dart';

class SignupForm extends ConsumerStatefulWidget {
  final VoidCallback handleToggle;

  const SignupForm({super.key, required this.handleToggle});
...
class _SignupFormState extends ConsumerState<SignupForm> {
  ...
  Widget build(BuildContext context) {
    final isLoading = ref.watch(
      authSignUpViewModelProvider.select((val) => val?.isLoading == true),
    );
