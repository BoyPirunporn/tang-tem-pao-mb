        ...
        child: ListTile(
          onTap: () {
            DialogProvider.instance.showDialogBox(
              title: "แก้ไข",
              content: AddCategoryForm(data: category),
            );
          },
          leading: CircleAvatar(
            ...
            child: Icon(
              CategoryUiHelper.getIconForType(category.type),
              color: Colors.white,
            ),
          ),
          title: Text(
          ...
          subtitle: Text(
            ...
            style: TextStyle(
              color: category.status == CategoryStatus.active ? AppPallete.primaryDark : AppPallete.destructiveDark,
              fontSize: DimensionConstant.responsiveFont(context, 16),
            ),
          ),
          trailing: Container(
            padding: EdgeInsets.symmetric(
              ...
              vertical: DimensionConstant.horizontalPadding(context, 1),
            ),
